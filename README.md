...
The user selects a coaching scenario.
Confidy starts an AI-powered conversation practice session.
Messages and sessions are saved in Supabase.
A Python backend analyzes user responses for communication and confidence signals.
Skill scores and feedback are updated live.
Users can review, resume, or delete previous sessions from the dashboard.
Project Structure
index.html
netlify.toml
